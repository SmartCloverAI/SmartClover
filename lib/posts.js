...
const postEditorialDefaults = {
  ...
  'cybersecurity-healthcare-ledger': {
    ...
    heroImage: '/images/architecture/healthcare-cyber-resilience-loop-napkin_v1.0.png',
    heroAlt: 'Healthcare cybersecurity resilience loop for assessment, hardening, monitoring, and review.'
  },
  ...
  'healthcare-ai-research': {
    ...
    heroImage: '/images/research-lab.png',
    heroAlt: 'Research workspace with clinical AI and evidence-review context.'
  },
  ...
  'on-prem-ledger-ci-cd': {
    ...
    heroImage: '/images/architecture/cloud-on-edge-boundaries-napkin_v1.0.png',
    heroAlt: 'Provider-neutral cloud-on-edge boundary diagram for permissioned healthcare AI deployment.'
  }
};
...
const figureCaptionDefaults = {
  ...
  '/blog/images/collaboration-flow-imagegen.png':
    'NIS2COMPASS combines compliance architecture, SmartClover engineering, and CYberSynchrony validation into public-safe project outputs.'
};
...
export const normalizePostMetadata = ({ slug, data, content }) => {
  ...
  const heroImage = resolveArticleImagePath(firstPresentString(mergedData.heroImage, mergedData.hero_image)) || markdownImages[0]?.src || defaultHeroImage;
...
export const getPostData = async (slug) => {
  ...
  const contentHtml = removeDuplicateHeroFigure(renderArticleFigures(addImageRuntimeAttributes(processedContent.toString())), metadata.heroImage);
