...
- `/products`
  Portfolio page covering CerviGuard, DataGems, and related SmartClover product framing.

- `/trust`
  Trust center entry point for privacy, security, incident response, and data-processing materials.

- `/pricing`
  RFQ-oriented pricing and commercial framing.

- `/how-to-buy`
  Qualification, buying, and onboarding flow.
...
- `https://huggingface.co/smartclover`
  Public Hugging Face organization/profile.
